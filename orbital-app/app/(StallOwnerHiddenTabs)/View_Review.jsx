...
/**
 * ViewReviewScreen component displays the details of a specific review.
 * @returns {JSX.Element} Review screen component JSX
 */
export default function ViewReviewScreen() {
  ...
  /**
   * Fetches the review details from the database.
   */
